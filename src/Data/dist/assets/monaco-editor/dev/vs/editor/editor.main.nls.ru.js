...
define("vs/editor/editor.main.nls.ru", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Определяет размер шрифта встроенных указаний в редакторе. Если задано значение \"0\", используется 90 % от \"#editor.fontSize#\".",
		...
		"Отображать только встроенное предложение, если заменяемый текст является префиксом вставляемого текста.",
		"Отображать только встроенное предложение, если заменяемый текст является подсловом вставляемого текста.",
		"Отображать встроенное предложение только в том случае, если замещающий текст является подсловом вставляемого текста, но подслово должно начинаться после курсора.",
		"Определяет, какой режим следует использовать для отрисовки встроенных предложений.",
		...
		"Подготавливать предварительный просмотр, только если заменяемый текст является префиксом вставляемого текста.",
		"Подготавливать предварительный просмотр, только если заменяемый текст является подсловом вставляемого текста.",
		"Выполнить предварительный просмотр, если замещающий текст является подсловом вставляемого текста или если это префикс вставляемого текста.",
		"Определяет, какой режим использовать для отображения предварительной версии предложений.",
		...
		"Определяет размер шрифта в пикселях для CodeLens. Если задано значение \"0\", то используется 90% от \"#editor.fontSize#\".",
	...
	"vs/editor/contrib/folding/folding": [
		...
		"Перейти к предыдущему свертыванию",
		"Перейти к следующему свертыванию",
		"Уровень папки {0}",
