...
define("vs/editor/editor.main.nls.es", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Controla el tamaño de la fuente de las sugerencias de incrustación en el editor. Cuando se establece en \"0\", se utiliza el 90% de \"#editor.fontSize#\".",
		...
		"Representar solo una sugerencia alineada si el texto de reemplazo es un prefijo del texto de inserción.",
		"Representar solo una sugerencia alineada si el texto de reemplazo es una subpalabra del texto de inserción.",
		"Solo representa una sugerencia alineada si el texto de reemplazo es una subpalabra del texto de inserción, pero la subpalabra debe iniciarse después del cursor.",
		"Controla el modo que se va a usar para representar sugerencias alineadas.",
		...
		"Representar solo una vista previa si el texto de reemplazo es un prefijo del texto de inserción.",
		"Representar solo una vista previa si el texto de reemplazo es una subpalabra del texto de inserción.",
		"Representa una vista previa si el texto de reemplazo es una subpalabra de la inserción de texto o si es un prefijo del texto de inserción.",
		"Controla el modo que se va a usar para representar la vista previa de sugerencias.",
	...
	"vs/editor/contrib/folding/folding": [
		...
		"Ir al plegado anterior",
		"Ir al plegado siguiente",
