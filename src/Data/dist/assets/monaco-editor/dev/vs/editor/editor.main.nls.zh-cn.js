...
define("vs/editor/editor.main.nls.zh-cn", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"在编辑器中启用代码操作小灯泡提示。",
		"在编辑器中启用内联提示。",
		"控制在编辑器中内联提示的字号。设置为 `0` 时，将使用 `#editor.fontSize#` 的 90%。",
		...
		"控制单击按页滚动还是跳转到单击位置。",
		"控制是否在编辑器中自动显示内联建议。",
		"仅当替换文本是插入文本的前缀时才呈现内联建议。",
		"仅当替换文本是插入文本的字词时才呈现内联建议。",
		"只有当替换文本为插入文本的子字时才呈现内联建议，但子字必须在光标之后开始。",
		"控制使用何种模式呈现内联建议。",
		...
		"控制建议小部件底部的状态栏的可见性。",
		"控制是否在编辑器中预览建议结果。",
		"仅当替换文本是插入文本的前缀时才呈现预览。",
		"仅当替换文本是插入文本的子词时才呈现预览。",
		"如果替换文本为插入文本的子字或前缀，则呈现预览。",
		"控制用于呈现建议预览的模式。",
	...
	"vs/editor/contrib/hover/markdownHoverParticipant": [
		"正在加载...",
		"出于性能原因，对长行跳过令牌化。这可以通过 “editor.maxTokenizationLineLength” 进行配置。",
	],
	...
	"vs/platform/list/browser/listService": [
		...
		"控制树是否应呈现缩进参考线。",
		"控制列表和树是否具有平滑滚动效果。",
		"要在鼠标滚轮滚动事件的 deltaX 和 deltaY 上使用的乘数。",
		"按 Alt 时滚动速度乘数。",
