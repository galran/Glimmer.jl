...
define("vs/editor/editor.main.nls.fr", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Affichez uniquement une suggestion inlined si le texte de remplacement est un préfixe du texte d’insertion.",
		"Affichez uniquement une suggestion inlined si le texte de remplacement est un sous-mot du texte d’insertion.",
		"Affichez uniquement une suggestion inlined si le texte de remplacement est un sous-mot du texte d’insertion, mais que le sous-mot doit commencer après le curseur.",
		...
		"Affichez un aperçu uniquement si le texte de remplacement est un préfixe du texte d’insertion.",
		"Affichez un aperçu uniquement si le texte de remplacement est un sous-mot du texte d’insertion.",
		"Afficher un aperçu si le texte de remplacement est un sous-mot du texte d’insertion ou s’il s’agit d’un préfixe du texte d’insertion.",
	...
	"vs/editor/contrib/folding/folding": [
		...
		"Atteindre le pli précédent",
		"Atteindre le pli suivant",
		"Niveau de pliage {0}",
