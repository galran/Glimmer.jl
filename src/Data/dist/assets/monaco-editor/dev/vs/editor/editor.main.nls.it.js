...
define("vs/editor/editor.main.nls.it", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Controlla la famiglia di caratteri dei suggerimenti incorporati nell\'Editor. Se impostato su vuoto, viene usato \'#editor.fontFamily#\'.",
		...
		"Esegue il rendering di un suggerimento inline solo se il testo di sostituzione è una sottoparola del testo di inserimento, ma la sottoparola deve iniziare dopo il cursore.",
		...
		"Eseguire il rendering di un\'anteprima se il testo di sostituzione è una sottoparola del testo di inserimento o se è un prefisso del testo di inserimento.",
