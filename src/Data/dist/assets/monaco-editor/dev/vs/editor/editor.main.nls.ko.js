...
define("vs/editor/editor.main.nls.ko", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"편집기에서 인레이 힌트의 글꼴 크기를 제어합니다. `0`으로 설정하면 `#editor.fontSize#`의 90%가 사용됩니다.",
		...
		"바꾸기 텍스트가 삽입 텍스트의 접두사인 경우에만 인라인 제안을 렌더링합니다.",
		"바꾸기 텍스트가 삽입 텍스트의 하위 단어인 경우에만 인라인 제안을 렌더링합니다.",
		"대체 텍스트가 삽입 텍스트의 하위 단어인 경우에만 인라인 제안을 렌더링하지만 하위 단어는 커서 뒤에 시작해야 합니다.",
		"인라인 제안을 렌더링하는 데 사용할 모드를 제어합니다.",
		...
		"바꾸기 텍스트가 삽입 텍스트의 접두사인 경우에만 미리 보기를 렌더링합니다.",
		"바꾸기 텍스트가 삽입 텍스트의 하위 단어인 경우에만 미리 보기를 렌더링합니다.",
		"대체 텍스트가 삽입 텍스트의 하위 단어이거나 삽입 텍스트의 접두사인 경우 미리 보기를 렌더링합니다.",
		"제안 미리 보기를 렌더링하는 데 사용할 모드를 제어합니다.",
	...
	"vs/platform/list/browser/listService": [
		...
		"마우스 휠 스크롤 이벤트의 deltaX 및 deltaY에서 사용할 승수입니다.",
		"Alt 키를 누를 때 스크롤 속도 승수입니다.",
