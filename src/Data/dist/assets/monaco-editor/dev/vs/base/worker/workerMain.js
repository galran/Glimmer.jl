 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[7/*vs/base/common/lifecycle*/], __M([0/*require*/,1/*exports*/,15/*vs/base/common/functional*/,16/*vs/base/common/iterator*/]), function (require, exports, functional_1, iterator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[2/*vs/base/common/platform*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    ...
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isLittleEndian = exports.OS = exports.setImmediate = exports.userAgent = exports.isIOS = exports.isWeb = exports.isNative = exports.isLinux = exports.isMacintosh = exports.isWindows = exports.globals = void 0;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/base/common/diff/diff*/], __M([0/*require*/,1/*exports*/,14/*vs/base/common/diff/diffChange*/,22/*vs/base/common/hash*/]), function (require, exports, diffChange_1, hash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[13/*vs/base/common/uri*/], __M([0/*require*/,1/*exports*/,20/*vs/base/common/path*/,2/*vs/base/common/platform*/]), function (require, exports, paths, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[30/*vs/editor/common/standalone/standaloneEnums*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    ...
    (function (EditorOption) {
        ...
        EditorOption[EditorOption["codeLens"] = 13] = "codeLens";
        EditorOption[EditorOption["codeLensFontFamily"] = 14] = "codeLensFontFamily";
        EditorOption[EditorOption["codeLensFontSize"] = 15] = "codeLensFontSize";
        EditorOption[EditorOption["colorDecorators"] = 16] = "colorDecorators";
        EditorOption[EditorOption["columnSelection"] = 17] = "columnSelection";
        EditorOption[EditorOption["comments"] = 18] = "comments";
        EditorOption[EditorOption["contextmenu"] = 19] = "contextmenu";
        EditorOption[EditorOption["copyWithSyntaxHighlighting"] = 20] = "copyWithSyntaxHighlighting";
        EditorOption[EditorOption["cursorBlinking"] = 21] = "cursorBlinking";
        EditorOption[EditorOption["cursorSmoothCaretAnimation"] = 22] = "cursorSmoothCaretAnimation";
        EditorOption[EditorOption["cursorStyle"] = 23] = "cursorStyle";
        EditorOption[EditorOption["cursorSurroundingLines"] = 24] = "cursorSurroundingLines";
        EditorOption[EditorOption["cursorSurroundingLinesStyle"] = 25] = "cursorSurroundingLinesStyle";
        EditorOption[EditorOption["cursorWidth"] = 26] = "cursorWidth";
        EditorOption[EditorOption["disableLayerHinting"] = 27] = "disableLayerHinting";
        EditorOption[EditorOption["disableMonospaceOptimizations"] = 28] = "disableMonospaceOptimizations";
        EditorOption[EditorOption["domReadOnly"] = 29] = "domReadOnly";
        EditorOption[EditorOption["dragAndDrop"] = 30] = "dragAndDrop";
        EditorOption[EditorOption["emptySelectionClipboard"] = 31] = "emptySelectionClipboard";
        EditorOption[EditorOption["extraEditorClassName"] = 32] = "extraEditorClassName";
        EditorOption[EditorOption["fastScrollSensitivity"] = 33] = "fastScrollSensitivity";
        EditorOption[EditorOption["find"] = 34] = "find";
        EditorOption[EditorOption["fixedOverflowWidgets"] = 35] = "fixedOverflowWidgets";
        EditorOption[EditorOption["folding"] = 36] = "folding";
        EditorOption[EditorOption["foldingStrategy"] = 37] = "foldingStrategy";
        EditorOption[EditorOption["foldingHighlight"] = 38] = "foldingHighlight";
        EditorOption[EditorOption["foldingImportsByDefault"] = 39] = "foldingImportsByDefault";
        EditorOption[EditorOption["unfoldOnClickAfterEndOfLine"] = 40] = "unfoldOnClickAfterEndOfLine";
        EditorOption[EditorOption["fontFamily"] = 41] = "fontFamily";
        EditorOption[EditorOption["fontInfo"] = 42] = "fontInfo";
        EditorOption[EditorOption["fontLigatures"] = 43] = "fontLigatures";
        EditorOption[EditorOption["fontSize"] = 44] = "fontSize";
        EditorOption[EditorOption["fontWeight"] = 45] = "fontWeight";
        EditorOption[EditorOption["formatOnPaste"] = 46] = "formatOnPaste";
        EditorOption[EditorOption["formatOnType"] = 47] = "formatOnType";
        EditorOption[EditorOption["glyphMargin"] = 48] = "glyphMargin";
        EditorOption[EditorOption["gotoLocation"] = 49] = "gotoLocation";
        EditorOption[EditorOption["hideCursorInOverviewRuler"] = 50] = "hideCursorInOverviewRuler";
        EditorOption[EditorOption["highlightActiveIndentGuide"] = 51] = "highlightActiveIndentGuide";
        ...
        EditorOption[EditorOption["renderIndentGuides"] = 83] = "renderIndentGuides";
...
define(__m[35/*vs/editor/common/services/editorSimpleWorker*/], __M([0/*require*/,1/*exports*/,10/*vs/base/common/diff/diff*/,2/*vs/base/common/platform*/,13/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,6/*vs/editor/common/core/range*/,26/*vs/editor/common/diff/diffComputer*/,33/*vs/editor/common/model/mirrorTextModel*/,27/*vs/editor/common/model/wordHelper*/,28/*vs/editor/common/modes/linkComputer*/,29/*vs/editor/common/modes/supports/inplaceReplaceSupport*/,31/*vs/editor/common/standalone/standaloneBase*/,11/*vs/base/common/types*/,8/*vs/base/common/stopwatch*/]), function (require, exports, diff_1, platform_1, uri_1, position_1, range_1, diffComputer_1, mirrorTextModel_1, wordHelper_1, linkComputer_1, inplaceReplaceSupport_1, standaloneBase_1, types, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
