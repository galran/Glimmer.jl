...
export class TextAreaHandler extends ViewPart {
    constructor(context, viewController, viewHelper) {
        ...
        this._fontInfo = options.get(42 /* fontInfo */);
        this._lineHeight = options.get(58 /* lineHeight */);
        this._emptySelectionClipboard = options.get(31 /* emptySelectionClipboard */);
        this._copyWithSyntaxHighlighting = options.get(20 /* copyWithSyntaxHighlighting */);
        ...
        if (options.get(29 /* domReadOnly */) && options.get(80 /* readOnly */)) {
    ...
    onConfigurationChanged(e) {
        ...
        this.textArea.setAttribute('aria-label', this._getAriaLabel(options));
        this.textArea.setAttribute('tabindex', String(options.get(112 /* tabIndex */)));
        if (e.hasChanged(29 /* domReadOnly */) || e.hasChanged(80 /* readOnly */)) {
            if (options.get(29 /* domReadOnly */) && options.get(80 /* readOnly */)) {
                this.textArea.setAttribute('readonly', 'true');
            }
            else {
