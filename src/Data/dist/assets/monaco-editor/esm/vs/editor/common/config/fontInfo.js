...
export class BareFontInfo {
    ...
    static createFromValidatedSettings(options, zoomLevel, pixelRatio, ignoreEditorZoom) {
        const fontFamily = options.get(41 /* fontFamily */);
        const fontWeight = options.get(45 /* fontWeight */);
        const fontSize = options.get(44 /* fontSize */);
        const fontFeatureSettings = options.get(43 /* fontLigatures */);
