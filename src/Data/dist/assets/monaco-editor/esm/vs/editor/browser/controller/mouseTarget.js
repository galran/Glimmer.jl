...
export class HitTestContext {
    constructor(context, viewHelper, lastRenderData) {
        ...
        this.typicalHalfwidthCharacterWidth = options.get(42 /* fontInfo */).typicalHalfwidthCharacterWidth;
...
export class MouseTargetFactory {
    ...
    getMouseColumn(editorPos, pos) {
        ...
        return MouseTargetFactory._getMouseColumn(mouseContentHorizontalOffset, options.get(42 /* fontInfo */).typicalHalfwidthCharacterWidth);
    }
