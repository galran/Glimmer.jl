...
export class ViewCursors extends ViewPart {
    constructor(context) {
        ...
        this._cursorBlinking = options.get(21 /* cursorBlinking */);
        this._cursorStyle = options.get(23 /* cursorStyle */);
        this._cursorSmoothCaretAnimation = options.get(22 /* cursorSmoothCaretAnimation */);
