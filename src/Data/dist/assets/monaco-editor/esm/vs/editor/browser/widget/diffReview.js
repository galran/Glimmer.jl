...
export class DiffReview extends Disposable {
    ...
    _render() {
        ...
        Configuration.applyFontInfoSlow(container, modifiedOptions.get(42 /* fontInfo */));
    ...
    static _renderLine(model, options, tabSize, lineNumber) {
        ...
        const r = renderViewLine(new RenderLineInput((fontInfo.isMonospace && !options.get(28 /* disableMonospaceOptimizations */)), fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, 0, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, options.get(105 /* stopRenderingLineAfter */), options.get(88 /* renderWhitespace */), options.get(82 /* renderControlCharacters */), options.get(43 /* fontLigatures */) !== EditorFontLigatures.OFF, null));
        return r.html;
    }
}
