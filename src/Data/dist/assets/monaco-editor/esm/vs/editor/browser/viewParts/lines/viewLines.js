...
export class ViewLines extends ViewPart {
    constructor(context, linesContent) {
        ...
        this._cursorSurroundingLines = options.get(24 /* cursorSurroundingLines */);
        this._cursorSurroundingLinesStyle = options.get(25 /* cursorSurroundingLinesStyle */);
        this._canUseLayerHinting = !options.get(27 /* disableLayerHinting */);
