...
export class CursorConfiguration {
    constructor(languageIdentifier, modelOptions, configuration) {
        ...
        this.emptySelectionClipboard = options.get(31 /* emptySelectionClipboard */);
        this.copyWithSyntaxHighlighting = options.get(20 /* copyWithSyntaxHighlighting */);
    ...
    static shouldRecreate(e) {
        return (e.hasChanged(130 /* layoutInfo */)
            ...
            || e.hasChanged(31 /* emptySelectionClipboard */)
